...
{
    public abstract class BaseSearchableEntityController<TSearchableEntity, TSearchableEntityService> : BaseElasticSearchController<TSearchableEntity>
        where TSearchableEntity : class, ISearchableEntity, new()
        where TSearchableEntityService : ISearchableEntityService<TSearchableEntity>
    {

        protected ISearchableEntityService<TSearchableEntity> _searchableEntityService { get; }

        public BaseSearchableEntityController():base()
        {
            _searchableEntityService = DependencyResolver.Current.GetService<ISearchableEntityService<TSearchableEntity>>();
        }
