namespace AspCore.ElasticSearch.General
{
    public class ESConstants
    {
        public struct ErrorMessages
        {
            public const string ES_EXIST_INDEX_ERROR_OCCURRED = "ElasticSearch Exist Index Failure!";
            public const string ES_INIT_INDEX_ERROR_OCCURRED = "ElasticSearch Initialize Index Failure!";
