...
namespace AspCore.Web.Concrete
{
    public abstract class BaseAuthenticationController : Controller
    {
        ...
        private readonly IWebAuthenticationProvider<AuthenticationInfo> _authenticationProvider;
        ...
        public BaseAuthenticationController()
        {
            ...
            _authenticationProvider = DependencyResolver.Current.GetServiceByName<IWebAuthenticationProvider<AuthenticationInfo>>(AuthenticationProviderName);

        }
        private void Authenticate()
        {
            ServiceResult<AuthenticationInfo> serviceResult = _authenticationProvider.GetAuthenticationFormInfo();
        ...
        public void Login()
        {
            ...
            if (string.IsNullOrEmpty(tokenKey) || Storage.GetObject<AuthenticationTokenResponse>(tokenKey) == null)
            {
                ClearStorage();
                Authenticate();
            }
